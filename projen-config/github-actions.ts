      ...
      steps: [
        ...
        },
        {
          ...
          run: [
            ...
            '  cat .env | grep -E "^AUTH0_TEST_" | sed "s/SECRET=.*/SECRET=[REDACTED]/"',
            '  CLIENT_ID=$(grep "^AUTH0_TEST_CLIENT_ID=" .env | cut -d "=" -f2)',
            '  CLIENT_SECRET=$(grep "^AUTH0_TEST_CLIENT_SECRET=" .env | cut -d "=" -f2)',
            '  AUDIENCE=$(grep "^AUTH0_TEST_AUDIENCE=" .env | cut -d "=" -f2)',
